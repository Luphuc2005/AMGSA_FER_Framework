...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_2G_P2_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_2G_P2_%j.err
...
echo "============================================================"
echo " RAF-DB 2-GPU WORKER 2: Stages 4 -> 5"
echo "============================================================"
...
echo "============================================================"
echo " WORKER 2 (STAGES 4, 5) FINISHED SUCCESSFULLY!"
echo " End: $(date)"
echo "============================================================"