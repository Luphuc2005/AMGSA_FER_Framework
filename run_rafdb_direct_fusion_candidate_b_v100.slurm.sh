#!/bin/bash
#SBATCH --job-name=RAFDB_DIRECT_CAND_B
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_DIRECT_CAND_B_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/RAFDB_DIRECT_CAND_B_%j.err
...
mkdir -p logs outputs/rafdb_direct_fusion_candidate_b

export PYTHONUNBUFFERED=1
export PYTHONPATH="$ROOT:${PYTHONPATH:-}"

FER_PY="/home/ptbao/projects/FER2013_MGR_CNN/fer2013_env/bin/python"
CONFIG="$ROOT/config_rafdb_direct_fusion_candidate_b.yaml"

echo "============================================================"
echo " RAF-DB Candidate B: Direct Global+Regional Fusion (Natural Distribution)"
echo " Config: $CONFIG"
echo " Output: outputs/rafdb_direct_fusion_candidate_b"
echo "============================================================"
...
echo "============================================================"
"$FER_PY" -u scripts/check_rafdb_direct_fusion_contract.py --config "$CONFIG" --candidate b

# 2. Train Model
echo "============================================================"
echo " Step 2: Training RAF-DB Candidate B Model..."
echo "============================================================"
