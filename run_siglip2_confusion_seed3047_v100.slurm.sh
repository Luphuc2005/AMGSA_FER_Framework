...
echo "FER_PY=$FER_PY"
echo "CONFIG=$CONFIG"
echo "Output: outputs/papers/siglip2-confusion-seed3047"
echo "============================================================"
...
echo "============================================================"
BEST_LOSS_CKPT=$(ls -t "$ROOT"/outputs/papers/siglip2-confusion-seed3047*/checkpoints/best_loss/ckpt-*.index 2>/dev/null | head -n 1 | sed 's/\.index$//' || true)
...
echo "============================================================"
echo " Completed Seed 3047 Pipeline (Training + TTA + Top-5 Ensemble)"
echo " End: $(date)"
echo "============================================================"
