#!/bin/bash
#SBATCH --job-name=FER_SIGLIP2_SEED43
...
#SBATCH --mem=64G
#SBATCH --output=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_SIGLIP2_SEED43_%j.out
#SBATCH --error=/home/ptbao/projects/FER2013_MGR_CNN/logs/FER_SIGLIP2_SEED43_%j.err
...
mkdir -p logs outputs/papers/siglip2-confusion-seed43

export PYTHONUNBUFFERED=1
export PYTHONPATH="$ROOT:${PYTHONPATH:-}"

FER_PY="/home/ptbao/projects/FER2013_MGR_CNN/fer2013_env/bin/python"
CONFIG="$ROOT/config_convnext_base_ms1m_adaptive_siglip2_confusion_seed43.yaml"

echo "============================================================"
echo " FER2013 ConvNeXt-Base MS1M SigLIP 2 Confusion (Seed 43)"
...
echo "FER_PY=$FER_PY"
echo "CONFIG=$CONFIG"
echo "Output: outputs/papers/siglip2-confusion-seed43"
echo "============================================================"
...
echo "============================================================"
BEST_LOSS_CKPT=$(ls -t "$ROOT"/outputs/papers/siglip2-confusion-seed43*/checkpoints/best_loss/ckpt-*.index 2>/dev/null | head -n 1 | sed 's/\.index$//' || true)
...
echo "============================================================"
echo " Completed Seed 43 Pipeline (Training + TTA + Top-5 Ensemble)"
echo " End: $(date)"
echo "============================================================"
