...
mkdir -p logs outputs/papers/siglip2-confusion-seed123

export PYTHONUNBUFFERED=1
export PYTHONPATH="$ROOT:${PYTHONPATH:-}"

FER_PY="/home/ptbao/projects/FER2013_MGR_CNN/fer2013_env/bin/python"
CONFIG="$ROOT/config_convnext_base_ms1m_adaptive_siglip2_confusion_seed123.yaml"
...
echo "============================================================"
BEST_LOSS_CKPT=$(ls -t "$ROOT"/outputs/papers/siglip2-confusion-seed123*/checkpoints/best_loss/ckpt-*.index 2>/dev/null | head -n 1 | sed 's/\.index$//' || true)
